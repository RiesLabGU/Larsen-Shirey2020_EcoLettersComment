...
The max altitude belongs to a record at "Mount Shasta" which is attributed to altitude very near the peak of the mountain. This is an extreme example, but indicates a potentially widespread problem with altitudes used in this analysis.
