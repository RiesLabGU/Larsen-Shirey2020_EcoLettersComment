...
## Need ID	name_resultsfile	region	phenometric	indep.variable	Fric_singleRegression_Sign	Fric_resid.regress_sign	Reanalysis_sign	Reanalysis_p	Reanalysis_coefficient	Fric_resid.regress_p	Fric_resid.regress_coefficient	Fric_singleRegression_p	Fric_singleRegression_coefficient												

```


## Create panels for Supplemental Figure 2
## In this code chunk, we used lm.model$call references in geom_smooth, which created a string of outputs showing the calls. We have thus changed the geom_smooth parameters to simply reference  x, y, and method="lm"
...
#pdf("testSuppFig1ab.pdf", dpi=600)
#sup1a
#sup1b
...
#### COMBINE ALL PANELS INTO SUPPLEMENTAL FIGURE 2
