...
date: "Current version 3-Dec-2020; initiated 9-Mar-2020"
...
#Fric et al methods stated they removed one species due to late season nests and removed all day 1 of the month records.
...
#Here we remove species E. aurinia from alldata, and use that, as our reproduction of the original analysis suggested that day 1 of the month occurrences were not actually removed, except for January.

alldata<-alldata %>%   filter(name!="Euphydryas aurinia")
...
#"SuccDay" = 30*(month-1)+day. We'd prefer to use calendar day
